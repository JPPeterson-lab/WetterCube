...
void fetchWeather() {
    ...
    if (httpCode == 200) {
        ...
        // --- Screen 3: UV-Index, Sunrise, Sunset ---
        float uvMax = doc["daily"]["uv_index_max"][0].as<float>();
        lv_label_set_text(ui_LabelUV, (String((int)round(uvMax))).c_str());

        // Sunrise/Sunset liefert ISO8601, z.B. "2025-06-01T05:32" → ab Index 11 die Zeit
        ...
        lv_label_set_text(ui_LabelSunrise, sunriseTime.c_str());
        lv_label_set_text(ui_LabelSunset,  sunsetTime.c_str());
