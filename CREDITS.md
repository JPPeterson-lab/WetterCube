...
Verwendete Icons:
- `day_clear.png` – Klarer Himmel
- `overcast.png` – Bewölkt
- `rain.png` – Regen
- `rain_80x80.png` – Regen (Warnscreen)
- `snow.png` – Schnee
- `thunder.png` – Gewitter
- `fog.png` – Nebel

Gemäß CC BY-SA 4.0 gilt:
- Die Icons wurden im Rahmen dieses Projekts unverändert übernommen
